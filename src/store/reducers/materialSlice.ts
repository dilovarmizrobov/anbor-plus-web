...
export const materialListSlice = createSlice({
    ...
    reducers: {
        ...
        getListSuccess: (state, action: PayloadAction<{ rows: IMaterialResponse[], rowsCount: number }>) => {
...
export const selectMaterial = (state: RootState) => state.materialList
