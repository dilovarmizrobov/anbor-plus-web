...
export const providerListSlice = createSlice({
    ...
    reducers: {
        ...
        getListProviderPending: (state) => {
            state.rows = [];
            state.rowsLoading = true;
            state.rowsError = false;
        },
        getListProviderSuccess: (state, action: PayloadAction<{ rows: IProviderResponse[], rowsCount: number }>) => {
            state.rows = action.payload.rows;
            state.rowsCount = action.payload.rowsCount;
            state.rowsLoading = false;
        },
        getListProviderError: (state) => {
...
export const {
    ...
    changePage,
    changeRowsPerPage,
    getListProviderPending,
    getListProviderSuccess,
    getListProviderError,
    deleteRow
} = providerListSlice.actions

export const selectProvider = (state: RootState) => state.providerList
